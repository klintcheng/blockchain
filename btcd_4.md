...
- [1. 节点发现与维护](#1-节点发现与维护)
    - [1.1. 简介](#11-简介)
    - [1.2. 启动AddrManager](#12-启动addrmanager)
        - [1.2.1. 本地读取地址信息](#121-本地读取地址信息)
        - [1.2.2. 同步到本地文件](#122-同步到本地文件)
        - [1.2.3. 从种子源获取地址](#123-从种子源获取地址)
    - [1.3. 获取随机地址方法](#13-获取随机地址方法)
        - [1.3.1. GetAddress](#131-getaddress)
    - [1.4. 从连接的节点获取](#14-从连接的节点获取)
        - [1.4.1. 获取节点地址](#141-获取节点地址)
        - [1.4.2. 把地址给其它节点](#142-把地址给其它节点)
